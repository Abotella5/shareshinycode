...
# Cerate a data frame with values from 0 to 50 for BMI and BFP. Add 3 factors:
#  (1) Categories according BMI cutoff points, (2) Categories according BFP male
#  cutoff points and (3) Categories according BFP female cutoff points.
#This data frame is out of shinyServer function because it is not reactive.
library (Hmisc)
...
shinyServer(function(input, output) {
        #Calcule BMI and BFP in reactive function. Both are in several render
         # functions
        BMIO <- reactive({
        ...
        #Ploting BMI line in nutritional categories
        ...
        # Ploting BFP line in nutritional categories, and differentiating
        # men from women
